// In this lab I mostly learned different types of variations to debug my program.
// I learned about breakpoints, data dumping and observation debugging methods.
// This code is mainly focused on the data dumping aspect as to not interfere with the programs work too much.
...
int main(void){  
  ...
  while(1){
		...
		if(!SW1 || !SW2){								// If either switch is pressed
