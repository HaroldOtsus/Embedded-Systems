// In this lab I had to write code in a different file and include that file into this main.c file and call the functions from UART.c file.
// The purpose of this lab was to send information from the microcontroller through UART.
