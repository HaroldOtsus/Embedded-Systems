//For this lab I had to use multiple subfunctions to mimic a heart pulse. When pressing a switch, the LED turns green and when letting go of the switch, there is a small delay before the LED turns red for 250 ms.
